...
def aturTabelJadwal(request, id_sarana):
    ...
    if request.method == 'GET':
        ...
        if sarana is not None:
            ...
            hari_buka = loads(jadwal_reservasi.hari_buka)
            jam_buka = loads(jadwal_reservasi.jam_buka)
            status_book = loads(jadwal_reservasi.status_book)
            ...
            context = {
                ...
                'status_book_raw': JSONEncoder().encode(status_book_raw)
            }
