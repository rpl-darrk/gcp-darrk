"""
Django settings for gcp_darrk project.
...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "django-insecure-n8!um9@nrocso2^6io0ox^7(0sea=^gi#ept3!75buo%$q%@^r"
)
...
WSGI_APPLICATION = "gcp_darrk.wsgi.application"
