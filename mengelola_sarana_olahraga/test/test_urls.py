...
class TestUrls(SimpleTestCase):
    ...
    def test_post_url_is_resolved(self):
        ...
        self.assertEqual(resolve_url.app_names, ['mengelola_sarana_olahraga'])
        self.assertEqual(resolve_url.namespaces, ['mengelola_sarana_olahraga'])
        self.assertEqual(resolve_url.route, 'mengelola_sarana_olahraga/post_sarana/')
    ...
    def test_update_url_is_resolved(self):
        ...
        self.assertEqual(resolve_url.app_names, ['mengelola_sarana_olahraga'])
        self.assertEqual(resolve_url.namespaces, ['mengelola_sarana_olahraga'])
        self.assertEqual(resolve_url.route, 'mengelola_sarana_olahraga/update_sarana/<str:id_sarana>')
    ...
    def test_delete_url_is_resolved(self):
        ...
        self.assertEqual(resolve_url.app_names, ['mengelola_sarana_olahraga'])
        self.assertEqual(resolve_url.namespaces, ['mengelola_sarana_olahraga'])
        self.assertEqual(resolve_url.route, 'mengelola_sarana_olahraga/delete_sarana/<str:id_sarana>')
