...
class TestViews(TestCase):
    def setUp(self):
        self.client = Client()
        self.get_jadwal_url = reverse('melihat_jadwal_reservasi:get_jadwal_reservasi', args=['1', '1'])
        ...
        self.sewa_sarana_2 = SewaSarana.objects.create(
            ID_sewa="2",
    ...
    def test_get_jadwal_reservasi_GET(self):
        ...
        self.assertTemplateUsed(response, 'melihat_jadwal_reservasi/index.html')
    ...
    def test_get_jadwal_reservasi_POST(self):
        ...
        self.assertTemplateNotUsed(response, 'melihat_jadwal_reservasi/index.html')
        self.assertTemplateNotUsed(response, 'mengelola_sarana_olahraga/index.html')
        self.assertTemplateNotUsed(response, 'mengelola_sarana_olahraga/form.html')
